...
public class GameMap {
    ...
    public GameMap(){
        ...
        blocks[23] = new RegularBlock(blockPositions[23], "graphics/long_block_left.png");
        blocks[24] = new RegularBlock(blockPositions[24], "graphics/long_block_center.png");
        blocks[25] = new RegularBlock(blockPositions[25], "graphics/long_block_center.png");
        blocks[26] = new RegularBlock(blockPositions[26], "graphics/long_block_right.png");
        ...
        blocks[29] = new RegularBlock(blockPositions[29], "graphics/green_block.png");
        blocks[30] = new RegularBlock(blockPositions[30], "graphics/green_block.png");
        blocks[31] = new RegularBlock(blockPositions[31], "graphics/blue_block.png");
        blocks[32] = new RegularBlock(blockPositions[32], "graphics/green_block.png");
        blocks[33] = new RegularBlock(blockPositions[33], "graphics/blue_block.png");
        blocks[34] = new RegularBlock(blockPositions[34], "graphics/green_block.png");
        blocks[35] = new RegularBlock(blockPositions[35], "graphics/long_block_left.png");
        blocks[36] = new RegularBlock(blockPositions[36], "graphics/long_block_center.png");
        blocks[37] = new RegularBlock(blockPositions[37], "graphics/long_block_center.png");
        blocks[38] = new RegularBlock(blockPositions[38], "graphics/long_block_right.png");
